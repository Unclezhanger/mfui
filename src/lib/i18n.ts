...
const DICT: Record<string, string> = {
  ...
  '内核': 'kernel',
  // ---------- v4.5 交互改造 ----------
  '开始新下载': 'Start new download',
  '音乐根目录不能为空': 'Music root directory cannot be empty',
  '浏览': 'Browse',
  '选择音乐根目录': 'Choose music root directory',
  '点击文件夹进入，选好后点「使用此目录」。': 'Click a folder to enter it, then press "Use this directory".',
  '上一级': 'Up',
  '读取中…': 'Loading…',
  '无子文件夹（可点「使用此目录」选择当前位置）': 'No subfolders (press "Use this directory" to pick the current location)',
  '或手动输入绝对路径': 'Or type an absolute path',
  '前往': 'Go',
  '使用此目录': 'Use this directory',
  '无法读取该目录': 'Cannot read this directory',
  '取消隐藏 {n}': 'Unhide {n}',
  '隐藏 {n}': 'Hide {n}',
  '音乐根目录下的文件夹：': 'Folders under the music root:',
  '选择文件夹': 'Select folder',
  '选歌手文件夹列表中要过滤掉的目录；可全部不选': 'Directories to filter out of the artist folder list; none required',
